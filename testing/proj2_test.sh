...
if [ $# -eq 1 ] && [ $1 = "--show" ];
	...
	then
		#test log (-inf)
                echo "`$1 --log -inf 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
		if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test log (-20)
                echo "`$1 --log -20 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test log (0)
                echo "`$1 --log 0 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "-inf" ] && [ `cat /tmp/proj2_test | tail -1` = "-inf" ];
		...
		#test log (1)
                echo "`$1 --log 1 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "0" ] && [ `cat /tmp/proj2_test | tail -1` = "0" ];
		...
		#test log (nan)
                echo "`$1 --log nan 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test pow (0,20)
                echo "`$1 --pow 0 20 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test pow (-20,20)
		echo "`$1 --pow -20 20 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test pow (1,20)
                echo "`$1 --pow 1 20 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "1" ] && [ `cat /tmp/proj2_test | tail -1` = "1" ];
		...
		#test pow (1,inf)
                echo "`$1 --pow 1 inf 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "1" ] && [ `cat /tmp/proj2_test | tail -1` = "1" ];
		...
		#test pow (1,nan)
                echo "`$1 --pow 1 nan 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "1" ] && [ `cat /tmp/proj2_test | tail -1` = "1" ];
		...
		#test pow (20,0)
                echo "`$1 --pow 20 0 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "1" ] && [ `cat /tmp/proj2_test | tail -1` = "1" ];
		...
		#test pow (inf,0)
                echo "`$1 --pow inf 0 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "1" ] && [ `cat /tmp/proj2_test | tail -1` = "1" ];
		...
		#test pow (nan,0)
                echo "`$1 --pow nan 0 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "1" ] && [ `cat /tmp/proj2_test | tail -1` = "1" ];
		...
		#test pow (0.5,-inf)
                echo "`$1 --pow 0.5 -inf 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "inf" ] && [ `cat /tmp/proj2_test | tail -1` = "inf" ];
		...
		#test pow (20,-inf)
                echo "`$1 --pow 20 -inf 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "0" ] && [ `cat /tmp/proj2_test | tail -1` = "0" ];
		...
		#test pow (inf,-inf)
                echo "`$1 --pow inf -inf 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "0" ] && [ `cat /tmp/proj2_test | tail -1` = "0" ];
		...
		#test pow (nan,-inf)
                echo "`$1 --pow nan -inf 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test pow (inf,-20)
                echo "`$1 --pow inf -20 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "0" ] && [ `cat /tmp/proj2_test | tail -1` = "0" ];
		...
		#test pow (20,nan)
                echo "`$1 --pow 20 nan 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test pow (inf,nan)
                echo "`$1 --pow inf nan 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
		...
		#test pow (nan,nan)
                echo "`$1 --pow nan nan 4 | tr -d " " | cut -d= -f2`" | tail -2 > /tmp/proj2_test
                if [ `cat /tmp/proj2_test | head -1` = "nan" ] && [ `cat /tmp/proj2_test | tail -1` = "nan" ];
